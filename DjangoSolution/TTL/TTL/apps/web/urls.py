...
service_provider_patterns = [
    ...
    re_path(r'^ct/$', TTL.apps.web.views.sp.ClientTypeListView.as_view(), name='clienttype-list'),
    re_path(r'^ct/(?P<pk>\d+)$', TTL.apps.web.views.sp.ClientTypeDetailView.as_view(), name='clienttype-detail'),
